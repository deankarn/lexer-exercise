...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    c.bench(
        "lex",
        Benchmark::new("lex_small1", move |b| {
            b.iter(|| {
                let lexer = Document::new(input.as_bytes());
                for _ in lexer {}
            })
        })
    ...
    c.bench(
        "lex",
        Benchmark::new("lex_small1_pretty", move |b| {
            b.iter(|| {
                let lexer = Document::new(input.as_bytes());
                for _ in lexer {}
            })
    ...
    c.bench(
        "lex",
        Benchmark::new("lex_small3", move |b| {
            b.iter(|| {
                let lexer = Document::new(input.as_bytes());
                for _ in lexer {}
            })
    ...
    c.bench(
        "lex",
        Benchmark::new("lex_small3_pretty", move |b| {
            b.iter(|| {
                let lexer = Document::new(input.as_bytes());
                for _ in lexer {}
            })
